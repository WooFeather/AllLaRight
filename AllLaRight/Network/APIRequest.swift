...
enum APIRequest {
    case upbitMarket
    case coingeckoMarket(ids: [String])
    ...
    var endpoint: URL {
        ...
        case .coingeckoMarket(let ids):
            return URL(string: coingeckoBaseURL + "coins/markets?vs_currency=krw&sparkline=true&ids=\(ids.joined(separator: ","))")!
        case .coingeckoTrending:
